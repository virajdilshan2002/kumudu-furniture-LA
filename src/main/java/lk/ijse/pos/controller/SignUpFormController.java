...
import lk.ijse.kumudufurniture.util.TextField;
...
public class SignUpFormController {
    ...
    public void btnSignUpClickOnAction(ActionEvent actionEvent) {
        ...
        /*boolean isEmpty = checkDetails(userName,password,fullName,email);
        if (!isEmpty){*/
        boolean isValid = isValid();
        if (isValid) {
            Credential credential = new Credential(userName, fullName, email, password);
            try {
                boolean isSaved = CredentialRepo.saveCredential(credential);
                if (isSaved) {
    ...
    public boolean checkDetails(String userName, String password, String fullName, String email) {
