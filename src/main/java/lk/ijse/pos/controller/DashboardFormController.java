...
public class DashboardFormController {
    ...
    private void setCompletedOrdersCount() {
        try {
            int count = OrderRepo.getCompletedOrdersCount();
    ...
    private void setToBePaidOrdersCount() {
        try {
            int count = OrderRepo.getToBePaidOrdersCount();
    ...
    private void setFurnitureCount() {
        try {
            int count = FurnitureRepo.getFurnitureCount();
    ...
    private void setCustomersCount() {
        try {
            int count = CustomerRepo.getCustomersCount();
    ...
    public void btnGenerateClickOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isFound = OrderRepo.isExistsOrder(id);
            if (isFound) {
